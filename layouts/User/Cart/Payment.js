    ...
    >
      ...
      <div className="w-full mb-2">
        ...
        <input
          ...
          className="w-full px-2 py-1.5 mt-1 tracking-wider text-xs font-semibold text-secondary bg-white border rounded-md focus:border-secondary focus:ring-secondary focus:outline-none focus:ring focus:ring-opacity-40"
        />
      </div>
      <div className="w-full mb-2">
        <label htmlFor="text" className="text-sm text-gray-800">
